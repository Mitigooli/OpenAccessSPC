% Implementing the SPC model for a SINGLE ROW of the sensor pixels of 
% the FOCUSED PLENOPTIC CAMERA setup
...
% Default setup 1: 
% (11X1 lenslets, 251 px, pitch=4.2 mm, g=12,51mm, f=12mm, f#=22)
...
MultiLensletImplementation = ['PC2_' num2str(n_l) 'x1_lenslet_output_decoupled_' num2str(n_x) 'pixel_p=' num2str(pitch/1000) 'mm_g=' num2str(g/1000) 'mm_f=' num2str(f/1000) 'mm_f#=' num2str(f_num) '.mat'];
